...
<body>
    <div class="card">
        <div class="logo">🏢 Inspire Offices Beheerportaal</div>
        <p class="tagline">Welkom bij het Inspire Offices Beheerportaal!</p>
        <p style="color:#475569;font-size:0.9rem;margin-bottom:8px;">Gemaakt door: Yassin, Mustafa, Emir, Musa, Moh en Krijn.</p>
        <p style="color:#475569;font-size:0.9rem;margin-bottom:16px;">Adem in, en uit.</p>
